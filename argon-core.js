        ...
        if (isDepartment) {
            ...
            <div style="background: #0f172a; border: 1px solid #334155; border-radius: 24px; padding: 40px; width: 90%; max-width: 450px; text-align: center; box-shadow: 0 24px 64px rgba(0,0,0,0.5);">
                ...
                <div id="entLoginStep2">
                    <input type="password" autocomplete="off" spellcheck="false" id="entPass" placeholder="كلمة المرور الخاصة بالقسم" style="width: 100%; padding: 14px; background: rgba(30, 41, 59, 0.8); border: 2px solid rgba(13, 148, 136, 0.4); border-radius: 12px; color: white; font-family: inherit; font-size: 1.1rem; margin-bottom: 20px; text-align: center; outline: none; box-shadow: inset 0 2px 4px rgba(0,0,0,0.3); transition: border-color 0.3s ease;" onfocus="this.style.borderColor='#0d9488';this.style.boxShadow='0 0 0 3px rgba(13,148,136,0.2), inset 0 2px 4px rgba(0,0,0,0.3)'" onblur="this.style.borderColor='rgba(13,148,136,0.4)';this.style.boxShadow='inset 0 2px 4px rgba(0,0,0,0.3)'" onkeyup="if(event.key==='Enter')ArgonPortalRuntime.doLogin('${portalName}', false)">
            ...
            <div style="background: #0f172a; border: 1px solid #334155; border-radius: 24px; padding: 40px; width: 90%; max-width: 450px; text-align: center; box-shadow: 0 24px 64px rgba(0,0,0,0.5);">
                ...
                <div id="entLoginStep1">
                    <select id="entUserSelect" style="width: 100%; padding: 14px; background: rgba(30, 41, 59, 0.8); border: 2px solid rgba(51, 65, 85, 0.8); border-radius: 12px; color: white; font-family: inherit; font-size: 1.05rem; margin-bottom: 20px; outline: none; box-shadow: inset 0 2px 4px rgba(0,0,0,0.2); appearance: none; cursor: pointer; text-align: center;" onfocus="this.style.borderColor='#0ea5e9'" onblur="this.style.borderColor='rgba(51,65,85,0.8)'">
                ...
                <div id="entLoginStep2" style="display: none;">
                    ...
                    <input type="password" autocomplete="off" spellcheck="false" id="entPass" placeholder="كلمة المرور الخاصة بك" style="width: 100%; padding: 14px; background: rgba(30, 41, 59, 0.8); border: 2px solid rgba(13, 148, 136, 0.4); border-radius: 12px; color: white; font-family: inherit; font-size: 1.1rem; margin-bottom: 20px; text-align: center; outline: none; box-shadow: inset 0 2px 4px rgba(0,0,0,0.3); transition: border-color 0.3s ease;" onfocus="this.style.borderColor='#0d9488';this.style.boxShadow='0 0 0 3px rgba(13,148,136,0.2), inset 0 2px 4px rgba(0,0,0,0.3)'" onblur="this.style.borderColor='rgba(13,148,136,0.4)';this.style.boxShadow='inset 0 2px 4px rgba(0,0,0,0.3)'" onkeyup="if(event.key==='Enter')ArgonPortalRuntime.doLogin('${portalName}', ${isDoctor})">
